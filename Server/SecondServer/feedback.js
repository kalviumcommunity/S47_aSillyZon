...
const uri =
  "mongodb+srv://somuyak:%40Somuya2004@cluster0.i2b8prd.mongodb.net/aSillyZon?retryWrites=true&w=majority";
mongoose.connect(uri).then(() => {
  console.log("Connected to MongoDB Atlas");

  app.get("/", (req, res) => {
    FeedModel.find({}).then((users) => res.json(users));
  });
  ...
  app.post("/login", (req, res) => {
    ...
    // Assuming you have a secret key defined somewhere
    const JWT_SECRET_KEY = "Somuya";
